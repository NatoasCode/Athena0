...
Are you looking for an easy way to practice ethical hacking or do you simply want a set of pentesting tools with a simple container __toolkit__  you can easily pull and run from a Docker container on a Raspberry Pi?  
...
(Email nathan.riley@notiapoint.com to learn more about Hide n’ Hunt for pentesting simulations. -- Thank you __Tony Huynh__ for helping create this game!)
...
| Host OS Running Docker - Raspberry Pi OS with Docker installed or HypriotOS

__*Inner-Athena Architecture Whitepaper:*__
https://docs.google.com/document/d/1lqriJFWpaTiiRvoaNvN5FdjF8GSDCvOFw5urQf080eA/edit
